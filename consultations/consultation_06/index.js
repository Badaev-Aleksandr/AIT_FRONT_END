...
for (let i = 1; i <= rows; i++) {
  let row = ""; // переменная, которая будет хранить значение текущей строки с результатом каждой итерации

  // внутренний цикл по столбцам
  for (let j = 1; j <= cols; j++) {
    // i * j = 1 * 1 - 11-я итерация внешнего цикла и 1-я итерация внутреннего цикла
...
//Пример 2. Поиск числа в матрице (первое совпадение)
const matrix = [
  [10, 15, 20, 25],
  [30, 15, 35, 40],
  [50, 60, 25],
