...
console.log(Math.max(...randomArr)); // разделит массив на значения
...
console.log(randomArr2);
// console.log(randomArr2.unshift("q")); // unshift - добавляет в начало и возвращает длину нового массива
